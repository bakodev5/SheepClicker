...
public class AdMobBanner : MonoBehaviour
{
...
#if UNITY_ANDROID
        string adUnitId = "ca-app-pub-1680686033556986/7085274520";//ここにAndroidのバナーIDを入力

#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-1680686033556986/1449804468";//ここにiOSのバナーIDを入力
    ...
    {
        Debug.Log("バナー読み込み失敗");//args.Message:エラー内容        
    }
